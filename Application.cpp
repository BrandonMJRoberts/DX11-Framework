...
//// ------------------------------------------------------------------------------------------ //
//
//// Constructor setting the default values for variables
...
//// ------------------------------------------------------------------------------------------ //
//
//// Destrutor that calls the cleanup function
//Application::~Application()
//{
//	Cleanup();
//}
...
//
//
//    // Error checking for the device init
...
//
//    // Use the built in functions to store the values efficiently
//	XMStoreFloat4x4(&_view, XMMatrixLookAtLH(Eye, At, Up));
//
//    // Initialize the projection matrix
//	XMStoreFloat4x4(&_projection, XMMatrixPerspectiveFovLH(XM_PIDIV2, _WindowWidth / (FLOAT) _WindowHeight, 0.01f, 100.0f));
//
//    // Return that the init process succeeded
//	return S_OK;
//}
//
//// ------------------------------------------------------------------------------------------ //
...
//{
//    // Error checking local variable
//	HRESULT hr;
//
//    // Compile the overall shader
...
//
//    // Error checking for the vertex shader compilation
//	if (FAILED(hr))
//	{	
//		pVSBlob->Release();
//        return hr;
...
//
//    // Error checking for the pixel shader compilation
//    if (FAILED(hr))
//    {
//        // Output the error
//        MessageBox(nullptr,
...
//
//    // Setup the data as it is going to be passed into the buffer
...
//    // Create window
//    _hInst = hInstance;
//    RECT rc = {0, 0, 640, 480}; // Set the screen corner positions
//
...
//{
//    // Error checking local variable defaulted to passing
//    HRESULT hr = S_OK;
//
...
//
//    // Init the shaders and the data input layout
//	InitShadersAndInputLayout();
//
//    // Init the vertex buffer we are going to be using
//	InitVertexBuffer();
//
//    // Set vertex buffer
...
//
//    // Init the index buffer for the objects we are going to be drawing
//	InitIndexBuffer();
//
//    // Set index buffer
...
//
//    // If we couldnt create the constant buffer then return the failure back
//    if (FAILED(hr))
//        return hr;
//
//    return S_OK;
...
//               DWORD dwTimeCur   = GetTickCount64(); // Get the current time
//
//        if (dwTimeStart == 0)
